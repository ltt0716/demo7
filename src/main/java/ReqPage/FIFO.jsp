<%@ page import="ClassZqs.Answer" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" pageEncoding="UTF-8" %>
<%--<%@ page import="ClassZqs.Answer" language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>--%>
<%--<%@ page import="ClassZqs.class1" language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>--%>
<html>
<head>
    <title>FIFO</title>
...
<body>
    ...
    <form action="/Curriculum_Design/FIFOServlet" method="POST">
        <div>
