...
@WebServlet(name = "LFUServlet", value = "/LFUServlet")
public class LFUServlet extends HttpServlet {
...
//            }
        ...
        request.getRequestDispatcher("/ReqPage/LFU.jsp").forward(request, response);
